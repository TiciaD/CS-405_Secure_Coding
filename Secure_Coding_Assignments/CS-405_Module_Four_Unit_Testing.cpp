...
TEST_F(CollectionTest, IsCapacityGreaterThanOrEqualToSize) {
    ...
    ASSERT_FALSE(collection->capacity() >= 5);
    add_entries(10);
...
TEST_F(CollectionTest, ResizeWillIncreaseCollectionSize) {
...
TEST_F(CollectionTest, ResizeWillDecreaseCollectionSize) {
...
TEST_F(CollectionTest, ClearWillEraseCollection) {
...
TEST_F(CollectionTest, EraseBeginEndWillEraseCollection) {
...
TEST_F(CollectionTest, ReserveWillIncreaseCapacityButNotSize) {
...
TEST_F(CollectionTest, OutOfRangeExceptionIsThrownWithOutOfBoundsIndex) {
...
TEST_F(CollectionTest, PushBackAddsElementToCollection) {
    ...
    EXPECT_EQ(collection->at(2), 3);
}

// NOTE: This is a negative test
TEST_F(CollectionTest, PopBackRemovesLastElementFromCollection) {
    add_entries(10);
    collection->push_back(1);

    EXPECT_EQ(collection->at(10), 1);
